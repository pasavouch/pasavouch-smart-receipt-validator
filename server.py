...
DIFF_LIMIT = 30       # max allowed pixel difference
EDGE_LIMIT = 15       # overlay edge limit
...
def validate_format():
    ...
    try:
        ...
        # aspect ratio comparison with template
